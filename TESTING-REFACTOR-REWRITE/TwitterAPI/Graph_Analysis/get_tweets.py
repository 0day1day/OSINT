                    ...
                    try:
                        if len(mentions) > 0:
                            for record in mentions:
                                ...
                                ordered_mentions_dict = OrderedDict(sorted(mentions_dict.items(), key=lambda t: t[0]))
                            ...
                            ordered_no_mentions_dict = OrderedDict(sorted(no_mentions_dict.items(), key=lambda t: t[0]))
